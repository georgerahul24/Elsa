...
def setting_page(username='', state=True):
    ...
    if state == True:
        ...
        clearhis = Button(
            a,
            text="Clear History",bd=0,bg=bg_colour,fg=text_color,
    ...
    close = Button(
        a,
        text="x",font='bold',bd=0, bg=bg_colour, fg=text_color,
        command=a.destroy)
    close.pack()
